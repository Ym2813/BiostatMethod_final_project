...
included pop in addition to pop18, pop65. Do we need pop tho? Would pop18 and pop65 be enough already?

did not include cty, state, area, crimes, totalinc, totalinc (included pcincome), do we need to include any of those? for example, both totalinc and pcincome, area and pop_den
...
crm_1000 ~ pop + pop18 + pop65 + hsgrad + bagrad + 
